  ...
  return (
    <div className="page-wrapper">
      <div className="content container-fluid">
        <Sidebar />
        <div className="row d-flex justify-content-center align-items-center contact-us">
          <div className="col-lg-6 mb-3 d-flex justify-content-center">
            <div>
              ...
              <p>
                <FontAwesomeIcon style={{ color: '#F8CB2E' }} className="me-2" icon={faStopwatch} /> ทุกวัน 9.00 - 23.00
              </p>
            </div>
          </div>
